...
import { api, isFridayReleaseDate } from '../api.js';
...
export default function EditorPage() {
  ...
  async function submit() {
    ...
    if (!isFridayReleaseDate(releaseTime)) return setError('投产日期只能选择星期五');
